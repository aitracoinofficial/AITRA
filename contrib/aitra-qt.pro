...
RESOURCES += src/qt/aitra.qrc src/qt/aitra_locale.qrc

TRANSLATIONS += src/qt/locale/aitra_bg.ts \
                src/qt/locale/aitra_de.ts \
                src/qt/locale/aitra_en.ts \
                src/qt/locale/aitra_es.ts \
                src/qt/locale/aitra_fi.ts \
                src/qt/locale/aitra_fr.ts \
                src/qt/locale/aitra_it.ts \
                src/qt/locale/aitra_ja.ts \
                src/qt/locale/aitra_pl.ts \
                src/qt/locale/aitra_pt.ts \
                src/qt/locale/aitra_ru.ts \
                src/qt/locale/aitra_sk.ts \
                src/qt/locale/aitra_sv.ts \
                src/qt/locale/aitra_vi.ts \
                src/qt/locale/aitra_zh_CN.ts \
                src/qt/locale/aitra_zh_TW.ts
