...
The build script we'll be using is contained in the AITRA_Coin github repository ([contrib/gitian-build.py](https://github.com/aitra-project/aitra/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the AITRA_Coin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/AITRA_Coin-Project/AITRA_Coin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, aitra-detached-sigs, and aitra GitHub repos.
