...
/** 
    ...
    ****Note - for AITRA_Coin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of aitra coming in to a transaction
