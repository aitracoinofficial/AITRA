...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop AITRA_Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "AITRA_Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AITRA_Coin features */
        {"aitra", "listmasternodes", &listmasternodes, true },
        {"aitra", "getmasternodecount", &getmasternodecount, true },
        {"aitra", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"aitra", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"aitra", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"aitra", "masternodecurrent", &masternodecurrent, true },
        {"aitra", "startmasternode", &startmasternode, true },
        {"aitra", "createmasternodekey", &createmasternodekey, true },
        {"aitra", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"aitra", "listmasternodeconf", &listmasternodeconf, true },
        {"aitra", "getmasternodestatus", &getmasternodestatus, true },
        {"aitra", "getmasternodewinners", &getmasternodewinners, true },
        {"aitra", "getmasternodescores", &getmasternodescores, true },
        {"aitra", "preparebudget", &preparebudget, true },
        {"aitra", "submitbudget", &submitbudget, true },
        {"aitra", "mnbudgetvote", &mnbudgetvote, true },
        {"aitra", "getbudgetvotes", &getbudgetvotes, true },
        {"aitra", "getnextsuperblock", &getnextsuperblock, true },
        {"aitra", "getbudgetprojection", &getbudgetprojection, true },
        {"aitra", "getbudgetinfo", &getbudgetinfo, true },
        {"aitra", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"aitra", "mnfinalbudget", &mnfinalbudget, true },
        {"aitra", "checkbudgets", &checkbudgets, true },
        {"aitra", "mnsync", &mnsync, true },
        {"aitra", "spork", &spork, true },
...
{
    return "> aitra-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2608/\n";
}
