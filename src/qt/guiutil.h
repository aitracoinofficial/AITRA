...
/** Utility functions used by the AITRA Qt UI.
 */
namespace GUIUtil
{
...
// Render AITRA addresses in monospace font
...
// Parse "aitra:" URI into recipient object, return true on successful parsing
