...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::AITRA);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeAitraAmount"))
        SoftSetArg("-anonymizeaitraamount", settings.value("nAnonymizeAitraAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in aitra.cpp during shotdown to also remove the window positions
