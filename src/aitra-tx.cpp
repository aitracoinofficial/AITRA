...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Aitra Coin aitra-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  aitra-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aitra transaction") + "\n" +
                               "  aitra-tx [options] -create [commands]   " + _("Create hex-encoded aitra transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded aitra transaction
