Contributing to AITRA Coin
============================

The AITRA Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/aitra-project/aitra/blob/master/doc/translation_process.md)
...
The following applies to code changes to the AITRA Coin project, and is not to be
confused with overall AITRA_Coin Network Protocol consensus changes.

Whether a pull request is merged into AITRA Coin rests with the project merge
...
Patches that change AITRA_Coin consensus rules are considerably more involved than
...
Where a patchset proposes to change the AITRA_Coin consensus, it must have been
...
The project leader is the release manager for each AITRA Coin release.
